export default function PrivacyPolicyPage() {
  return (
    <div className='p-4 pt-20 flex justify-center'>
      <div className='p-3 rounded-lg shadow-lg w-3/4 border border-stroke-gray'>
        <h1 className='text-center font-bold text-2xl'>Privacy Policy</h1>
        <p className='text-right'>Last updated: October 21, 2024</p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to พาน้องเตะบอล, 87/27 M.3 TaiKo,
              Samkhok, Pathumthani.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to พาน้องเตะบอล, accessible from{' '}
              <a
                href='www.panongtaeball.com'
                rel='external nofollow noopener'
                target='_blank'>
                www.panongtaeball.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: footballshot.juitanya@gmail.com</li>
        </ul>
      </div>
    </div>
  )
